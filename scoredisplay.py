...
#                self.update_layer()
	...
	def update_layer_1p(self):
        ...
        def set_text_blink(self,data):
            ...
            print 'Top text data store contains:%s',self.top_text_data_store
            print 'Bottom text data store contains:%s',self.bottom_text_data_store
            ...
            if self.blink_flag:
                ...
                print 'blinking, cleared'
            else:
                restore(self)
                self.blink_flag=True
                self.log.debug('blinking, restored')
                print 'blinking, restored'


            self.game.idle_mode.delay(name='text_blink_repeat'+str(row),delay=delay,handler=self.set_text_blink, param=data)
